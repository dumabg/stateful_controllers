# Using `state_controller`

`state_controller` separates Flutter UI from mutable application logic:
...
Do not import files from `package:state_controller/src/...`; they are internal
